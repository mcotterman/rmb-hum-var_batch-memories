...
basic.forever(function () {
    if(isRunning) {
        hummingbird.setTriLED(TwoPort.One, parseInt(getRmbVar("g1t1p1-r")), parseInt(getRmbVar("g1t1p1-g")), parseInt(getRmbVar("g1t1p1-b")));
        basic.pause(parseInt(getRmbVar("g1bp1")));
        hummingbird.setTriLED(TwoPort.One, parseInt(getRmbVar("g1t1p2-r")), parseInt(getRmbVar("g1t1p2-g")), parseInt(getRmbVar("g1t1p2-b")));
        basic.pause(parseInt(getRmbVar("g1bp2")));
    } else {
        basic.pause(500);
        hummingbird.setTriLED(TwoPort.One, 0, 0, 0);
...
basic.forever(function () {
    if(isRunning) {
        hummingbird.setTriLED(TwoPort.Two, parseInt(getRmbVar("g2t2p1-r")), parseInt(getRmbVar("g2t2p1-g")), parseInt(getRmbVar("g2t2p1-b")));
        basic.pause(parseInt(getRmbVar("g2bp1")));
        hummingbird.setTriLED(TwoPort.Two, parseInt(getRmbVar("g2t2p2-r")), parseInt(getRmbVar("g2t2p2-g")), parseInt(getRmbVar("g2t2p2-b")));
        basic.pause(parseInt(getRmbVar("g2bp2")));
    } else {
        basic.pause(500);
        hummingbird.setTriLED(TwoPort.Two, 0, 0, 0);
    }
})
